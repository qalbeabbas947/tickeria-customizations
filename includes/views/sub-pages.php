				...
				if( intval($is_round_table) == 1 ) {
					...
					<div class="tc-product-column">
						<table>
							<tr>
								<td>
									<img src="<?php echo get_the_post_thumbnail_url( $item->get_product_id(), 'post-thumbnail' ); ?>" width="90%"/>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								<td>
									<a href="<?php echo $temp_url; ?>"><?php _e( 'View / Edit Details', TC_TEXT_DOMAIN ); ?></a>
								</td>
							</tr>
						</table>
					</div>
